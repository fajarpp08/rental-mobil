        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-sm-8 col-md-6 col-lg-6 col-xl-4 order-4 order-md-1 order-lg-4 order-xl-1">
                    ...
                    <p class="footer__tagline">Aplikasi rental mobil di Indonesia <br>Sudah Melayani 66,000+ transaksi 
                        <br>Dan melayani berdasarkan kepuasan pelanggan</p>
                    ...
                    <div class="footer__lang">
                        ...
                        <ul class="dropdown-menu footer__lang-dropdown">
                            <li><a href="#"><img src="../assets-user/img/flags/spain.svg" alt=""><span>Spanish</span></a>
                            </li>
                            <li><a href="#"><img src="../assets-user/img/flags/france.svg" alt=""><span>French</span></a>
                            </li>
                            <li><a href="#"><img src="../assets-user/img/flags/china.svg" alt=""><span>Chinese</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="footer__content">
                        <div class="footer__social">
                            <a href="https://www.facebook.com/dedek.fpp" target="_blank"><svg xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24">
                                    <path
                            ...
                            <a href="https://www.instagram.com/dedekfajarpp" target="_blank"><svg xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24">
                                    <path
                            ...
                            <a href="https://x.com/Dedekfpp" target="_blank"><svg xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24">
                                    <path
                                        d="M22,5.8a8.49,8.49,0,0,1-2.36.64,4.13,4.13,0,0,0,1.81-2.27,8.21,8.21,0,0,1-2.61,1,4.1,4.1,0,0,0-7,3.74A11.64,11.64,0,0,1,3.39,4.62a4.16,4.16,0,0,0-.55,2.07A4.09,4.09,0,0,0,4.66,10.1,4.05,4.05,0,0,1,2.8,9.59v.05a4.1,4.1,0,0,0,3.3,4A3.93,3.93,0,0,1,5,13.81a4.9,4.9,0,0,1-.77-.07,4.11,4.11,0,0,0,3.83,2.84A8.22,8.22,0,0,1,3,18.34a7.93,7.93,0,0,1-1-.06,11.57,11.57,0,0,0,6.29,1.85A11.59,11.59,0,0,0,20,8.45c0-.17,0-.35,0-.53A8.43,8.43,0,0,0,22,5.8Z" />
                                </svg></a>

                            <a href="https://www.linkedin.com/in/fajar-putra-pratama" target="_blank"><svg xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24">
                                    <path
                        ...
                        <small class="footer__copyright">© Fajar Putra Pratama, 2024. Created by <a
                                href="https://github.com/fajarpp08" target="_blank">Fajar
                                Putra Pratama</a>.</small>
                    </div>
                </div>
            </div>
        </div>
